    ...
    <div class="hero-body">
      <div class="container">
        ...
        <div class="button-block">
          ...
          class="button is-xl is-dark">Sign Up to Browse Events</button>
          <h3 v-if="$auth.isAuthenticated"
          class="is-size-3 has-background-dark welcome">Welcome, {{ $auth.user.name }}!</h3>
        </div>
      </div>
    </div>
  </section>
